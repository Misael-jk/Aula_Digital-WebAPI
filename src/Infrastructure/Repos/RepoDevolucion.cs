...
public class RepoDevolucion : RepoBase, IRepoDevolucion
{
    ...
    {
        string query = "select idDevolucion, idPrestamo, idUsuarioDevolvio AS IdUsuario, fechaDevolucion AS FechaDevolucion, observaciones from Devoluciones where idPrestamo = @unidPrestamo";
